...
Blockly.Msg.NEOPIXEL_BEGIN_SETTING = "設定";  // untranslated
Blockly.Msg.NEOPIXEL_BEGIN_TOOLTIP = "設定燈條上 LED 的數目、使用的訊號腳，以及整體亮度";  // untranslated
...
Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_R = "顏色 R";
Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_TARGET = "設定 LED";
...
Blockly.Msg.NEOPIXEL_SETPIXELCOLOR_TOOLTIP = "設定 LED 顏色。此設定並不會自動刷新。";
...
Blockly.Msg.NEOPIXEL_WARNING = "需要「設定」積木。";  // untranslated
...
Blockly.Msg.CATEGORY_OLED = "OLED 顯示器";
